...
<body class="page-wrap">
    <div class="auth-card">
        ...
        <div class="text-center mb-7">
            <h1 style="font-size:1.5rem;font-weight:700;color:#111827;margin:0 0 .4rem">Welcome back</h1>
            <p style="color:#6b7280;font-size:.875rem;margin:0">Sign in to your account</p>
        </div>
        ...
        <form action="{{ route('admin.login') }}" method="POST" style="display:flex;flex-direction:column;gap:1.1rem">
            @csrf
            ...
            <div>
                ...
                <div style="text-align:right;margin-top:.35rem">
                    <a href="{{ route('admin.password.request') }}" style="font-size:.78rem;color:#6366f1;text-decoration:none;font-weight:600">Forgot password?</a>
                </div>
            </div>

            {{-- Remember me --}}
            <label style="display:flex;align-items:center;gap:.5rem;font-size:.875rem;color:#374151;cursor:pointer">
                <input type="checkbox" name="remember" style="width:15px;height:15px;accent-color:#6366f1;border-radius:3px">
                Remember me
            </label>
        ...
        <p style="text-align:center;margin-top:1.5rem;font-size:.875rem;color:#6b7280">
            ...
            <a href="{{ route('admin.register') }}" style="color:#6366f1;text-decoration:none;font-weight:600">Create one</a>
        </p>
        @endif
    </div>
