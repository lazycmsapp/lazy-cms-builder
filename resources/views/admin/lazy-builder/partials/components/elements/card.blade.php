    ...
    <div class="border border-dashed border-[#0091ea]/30 rounded-lg bg-gradient-to-br from-[#f8fbff] to-[#f0f6fb] p-5">
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-2">
                <div class="w-7 h-7 bg-[#0091ea] rounded flex items-center justify-center">
                    <i class="fa fa-th-large text-white text-[11px]"></i>
                </div>
                <span class="text-[12px] font-black text-[#1d2327] uppercase tracking-wider">Card</span>
            </div>
            <div class="flex items-center gap-2">
                <span v-if="el.settings.post_card_id && postCardsMap[el.settings.post_card_id]"
                      class="text-[10px] bg-[#0091ea] text-white px-2 py-0.5 rounded-full font-bold">
                ...
                <span class="text-[10px] bg-slate-100 text-slate-500 px-2 py-0.5 rounded-full font-bold capitalize">
        ...
        <div class="grid gap-3"
            ...
            <div v-for="n in Math.min(el.settings.posts_count || 6, el.settings.columns || 3)"
                ...
                <div class="p-2.5 space-y-1.5">
                    ...
                    <div class="h-5 bg-[#0091ea]/10 rounded w-1/3 mt-2"></div>
                </div>
            </div>
        </div>

        {{-- Info Row --}}
        <div class="mt-3 pt-3 border-t border-[#0091ea]/10 flex items-center flex-wrap gap-3 text-[10px] text-slate-400 font-bold">
