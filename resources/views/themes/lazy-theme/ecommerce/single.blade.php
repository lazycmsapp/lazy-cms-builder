    ...
    <div class="container-custom">
        ...
        <div class="flex flex-col md:flex-row gap-12">
            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center">
                <h1 class="text-3xl md:text-4xl font-bold text-heading mb-4">{{ $post->title }}</h1>
                ...
                @endphp
                @if($shortDescription)
                <div class="prose text-body mb-8">
                    {!! $shortDescription !!}
                </div>
                @endif
                ...
                <form action="{{ route('shop.cart.add') }}" method="POST" class="mb-10 flex items-center gap-4 border-b border-gray-100 pb-10">
                    ...
                    <button type="submit" class="flex-grow h-12 bg-primary text-white font-bold rounded hover:bg-primary-hover transition-colors duration-300">
                        Add to Cart
                    </button>
                </form>
                @endif
        ...
        <div class="mt-20 border-t border-gray-100 pt-12">
            <h3 class="text-2xl font-bold text-heading mb-8 inline-block border-b-2 border-primary pb-2">Description</h3>
